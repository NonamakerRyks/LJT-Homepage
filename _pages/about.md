...
I am a first-year PhD candidate in Computer Science at the [HKUST NLP Group](https://hkust-nlp.github.io/), Hong Kong University of Science and Technology, where I am advised by Professor Junxian He. I received my B.Eng. from Shanghai Jiao Tong University (SJTU), where I graduated in June 2024. My research focuses on natural language processing and machine learning.
...
- **On the Universal Truthfulness Hyperplane Inside LLMs** (2024). In *Proceedings of EMNLP 2024*.
  **Junteng Liu**, Shiqi Chen, Yu Cheng, Junxian He.
- **In-Context Sharpness as Alerts: An Inner Representation Perspective for Hallucination Mitigation** (2024). In *Proceedings of ICML 2024*.
  Shiqi Chen, Miao Xiong, Junteng Liu, Zhengxuan Wu, Teng Xiao, Siyang Gao, Junxian He.
- **C-Eval: A Multi-Level Multi-Discipline Chinese Evaluation Suite for Foundation Models** (2023). In *Proceedings of NeurIPS 2023*.
  Yuzhen Huang, Yuzhuo Bai, Zhihao Zhu, Junlei Zhang, Jinghan Zhang, Tangjun Su, Junteng Liu, Chuancheng Lv, Yikai Zhang, Jiayi Lei, Yao Fu, Maosong Sun, Junxian He.
- **Composing Parameter-Efficient Modules with Arithmetic Operations** (2023). In *Proceedings of NeurIPS 2023*.
